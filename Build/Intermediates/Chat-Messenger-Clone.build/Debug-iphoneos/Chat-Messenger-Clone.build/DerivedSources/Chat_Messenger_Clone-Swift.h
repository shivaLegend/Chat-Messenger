...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Chat_Messenger_Clone",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC20Chat_Messenger_Clone11AppDelegate")
...
SWIFT_CLASS("_TtC20Chat_Messenger_Clone17ChatTableViewCell")
